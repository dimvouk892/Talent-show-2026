...
Route::prefix('presentation/{talentShow:slug}')->group(function () {
    Route::get('/', ShowScreen::class)->name('presentation.show');
    Route::get('/ranking', RankingScreen::class)->name('presentation.ranking');
    Route::get('/winner', WinnerScreen::class)->name('presentation.winner');
});
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::get('/talent-shows/{talentShow}/screen-videos', ScreenVideos::class)->name('admin.talent-shows.screen-videos');
